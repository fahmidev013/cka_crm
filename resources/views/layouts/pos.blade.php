<!DOCTYPE html>
<head>
    <title>{{ $company_name }} | {{ __('Point of Sale') }}</title>
    ...
    {{-- Custom CSS for pos --}}
    <link rel="stylesheet" href="{{ asset('public/dist/css/pos/style-pos.min.css?v=1.0') }}">
    ...
    @endphp
        ...
        <link rel="stylesheet" href="{{ asset('public/datta-able/css/layouts/dark-custom.min.css?v=1.0') }}">
    @php } @endphp
