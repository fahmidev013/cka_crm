...
class FinalController extends AppController
{
    ...
    public function finish()
    {
        ...
        file_put_contents($path, str_replace('Infoamin\Installer\LaravelInstallerServiceProvider::class,', '// Infoamin\Installer\LaravelInstallerServiceProvider::class,', file_get_contents($path)));
